...
<!--[if IE 6]> 
<link href="<%=request.getContextPath()%>/staticsf/css/main.ie6.css" rel="stylesheet" type="text/css" />
<![endif]-->
<!--[if IE 7]> 
<link href="<%=request.getContextPath()%>/statics/css/main.ie7.css" rel="stylesheet" type="text/css" />
<![endif]-->
<script type="text/javascript" src="<%=request.getContextPath()%>/statics/js/jquery-1.5.1.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/statics/js/jquery-imgslideshow.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/statics/js/ks-switch.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/statics/js/lib.js"></script>
...
<div id="doc">
	<div id="s_hdw">
		...
		<div id="s_tbar">
			<div class="s_hd">
				<div class="tbar_lft">您好，欢迎来到一号店！<a href="#">请登录</a> | <a href="#">免费注册</a></div>
				<div class="tbar_rgt">
					<ul>
		...
		<div class="s_hd nav">
			<div id="s_logo"><a href="#"><img src="<%=request.getContextPath()%>/statics/images/logo.jpg" border="0" /></a></div>
			<div id="s_nav">
				<ul>
		...
		<div class="mmenu">
			<div class="s_hd">
				<div id="s_search">
					<form action="" method="post"><input name="" type="text" class="search-input" /><input name="" type="image" src="<%=request.getContextPath()%>/statics/images/btn_search.jpg" /></form>
				</div>
	...
	<link type="text/css" href="<%=request.getContextPath()%>/statics/css/detail.css" rel="stylesheet" />
	
	<div id="s_bdw">
		<div id="s_bd">
			<div class="zadv"><a href="#"><img src="<%=request.getContextPath()%>/statics/images/3215wa.jpg" width="980" height="62" alt="" /></a></div>
			...
			<div class="detail cf">
				...
				<div class="f-l filmslide">
					...
					<div id="vertical" class="bigImg">
						<img src="<%=request.getContextPath()%>/statics/images/mid/12da.jpg" width="380" height="380" alt="" id="midimg" />
					...
					<div class="smallpic">
						...
						<div class="smallscroll" id="imageMenu">
							<ul>
								<li id="onlickImg"><img src="<%=request.getContextPath()%>/statics/images/small/12da.jpg" /></li>
								<li><img src="<%=request.getContextPath()%>/statics/images/small/12da.jpg" /></li>
								<li><img src="<%=request.getContextPath()%>/statics/images/small/12da.jpg" /></li>
								<li><img src="<%=request.getContextPath()%>/statics/images/small/12da.jpg" /></li>
								<li><img src="<%=request.getContextPath()%>/statics/images/small/12da.jpg" /></li>
								<li><img src="<%=request.getContextPath()%>/statics/images/small/12da.jpg" /></li>
				...
				<script type="text/javascript" src="<%=request.getContextPath()%>/statics/js/slider.js"></script>
				<script type="text/javascript">
				$(document).ready(function(){
				...
				<div class="f-r desummary">
					...
					<div class="dl01"><span class="f-l">1号店价：<strong class="red">399</strong>元</span><a title="降价通知" class="downtip" href="#"></a><span class="f-l projf">购买该商品，可获得 <b class="red">310</b> 积分！ <a class="more" href="#">了解积分制度>></a></span></div>
					...
					<div class="dl06">
						<dl class="hg"><dt></dt><dd>1号店(除服装鞋帽)全场单笔消费满1元，即可换购以下赠品，赠完为止，多买多享</dd></dl>
						<div class="hgscrollbox">
							<a title="左移" href="#left" class="abtn aleft agrayleft"></a>
							<div class="hgscrollpic">
								<ul>
									<li>
										<a href="#"><img src="<%=request.getContextPath()%>/statics/images/1119969_115x115.jpg" width="115" height="115" alt="" /></a>
										<dl>
				...
				<div class="dtsummary">
					<dl>
						...
						<dd>
							...
							<div class="dtprodis">
								<img src="<%=request.getContextPath()%>/statics/images/32asd.jpg" width="797" height="298" alt="" />
							</div>
							<div class="dtbq">
								<h3>品牌介绍</h3>
				...
				<div class="discuss" id="mydiscuss">
					<h2>买家体验</h2>
					<dl>
						<dt class="discusstab"><a class="current" href="javascript:void(0);">全部评论</a><a href="javascript:void(0);">好评(${queryGoodCount})</a><a href="javascript:void(0);">中评(${queryZhongCount})</a><a href="javascript:void(0);">差评(${queryChaCount})</a></dt>
						<dd class="discusstabcon">
							<div class="discussnum cf">
								<div class="f-l disnum">
									<strong><%--<fmt:formatNumber type="percent" value="${queryGoodCount / queryAllCount}" maxFractionDigits="3" />--%>
<%--
										${queryGoodCount / queryAllCount}%
--%>											${GoodB}%
								...
								<div class="f-l disbar">
									<dl class="cf">
										<dt>好评</dt><dd class="barbox"><div class="bar" style="width:${GoodB}%;"></div></dd><dd>${GoodB}%</dd>
									</dl>
									<dl class="cf">
										<dt>中评</dt><dd class="barbox"><div class="bar" style="width:${ZhongB}%;"></div></dd><dd>${ZhongB}%</dd>
									</dl>
									<dl class="cf">
										<dt>差评</dt><dd class="barbox"><div class="bar" style="width:${ChaB}%;"></div></dd><dd>${ChaB}%</dd>
									</dl>
								</div>
								<div class="f-l pl5">前5位评论用户：
								<c:forEach items="${queryFive}" var="five">
									<span>${five.user.userNick},</span>
								</c:forEach>
								</div>
								<div class="f-r plbtn">
									<span>我在1号店买过此产品</span>
							...
							<div class="discusslist">
								<ul>
									<c:forEach items="${pageInfo}" var="all">
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="<%=request.getContextPath()%>/statics/images/qzx.gif" width="48" height="48" alt="" /></a><span>${all.user.userNick}</span></div>
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">${all.createTime}</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：${all.discussCount}</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
									</c:forEach>
						...
						<dd class="discusstabcon">
							<div class="discussnum cf">
								<div class="f-l disnum">
									<strong>${GoodB}%</strong><span>好评</span>
								</div>
								<div class="f-l disbar">
									<dl class="cf">
										<dt>好评</dt><dd class="barbox"><div class="bar" style="width:${GoodB}%;"></div></dd><dd>${GoodB}%</dd>
								...
								<div class="f-l pl5">前5位评论用户:<c:forEach items="${queryFive}" var="five">
                                    <span>${five.user.userNick},</span>
                                </c:forEach></div>
								<div class="f-r plbtn">
									<span>我在1号店买过此产品</span>
							...
							<div class="discusslist">
								<ul>
									...
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="<%=request.getContextPath()%>/statics/images/qzx.gif" width="48" height="48" alt="" /></a><span>${good.user.userNick}</span></div>
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">${good.createTime}</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：${good.discussCount}</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
									</c:forEach>
						...
						<dd class="discusstabcon">
							...
							<div class="discusslist">
								<ul>
									<c:forEach items="${listZhong}" var="zhong">
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="<%=request.getContextPath()%>/statics/images/qzx.gif" width="48" height="48" alt="" /></a><span>${zhong.user.userNick}</span></div>
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">${zhong.createTime}</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：${zhong.discussCount}</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
									</c:forEach>
						...
						<dd class="discusstabcon">
							...
							<div class="discusslist">
								<ul>
									<c:forEach items="${listCha}" var="cha">
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="<%=request.getContextPath()%>/statics/images/qzx.gif" width="48" height="48" alt="" /></a><span>${cha.user.userNick}</span></div>
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">${cha.createTime}</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：${cha.discussCount}</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
									</c:forEach>
								</ul>
					...
					<dl>
						...
						<dd class="discusstabcon">
							<div class="afqlist">
								...
								<dl class="cf">
									<dt class="answer"></dt><dd>您好，内有橡胶盖子，感谢您支持1号店！祝您购物愉快！</dd>
									<dd class="last">回答者：【管理员】 2011-11-01</dd>
								</dl>
								<div class="myanswer">
									<a class="f-r" href="#"><img src="<%=request.getContextPath()%>/statics/images/myanswer.gif" width="60" height="22" alt="我来解答" align="baseline" /></a><span class="f-r">共有1条解答</span>
								</div>
							</div>
							<div class="afqlist">
								<dl class="cf">
	...
	<div id="s_ftw">
		...
		<div id="s_ft">
			...
			<div class="ft_banners1 tac pbt10">
				<ul>
					<li><a href="#"><img src="<%=request.getContextPath()%>/statics/images/ft_1.gif" border="0" /></a></li>
					<li><a href="#"><img src="<%=request.getContextPath()%>/statics/images/ft_2.gif" border="0" /></a></li>
					<li><a href="#"><img src="<%=request.getContextPath()%>/statics/images/ft_3.gif" border="0" /></a></li>
				</ul>
			</div>
			<div class="copyright tac pbt10">版权所有 Copyright&copy; 一号店 All Rights Reserved 版权所有 </div>
			<div class="ft_banners2 tac">
				<ul>
					<li><a href="#"><img src="<%=request.getContextPath()%>/statics/images/u255.png" border="0" /></a></li>
					<li><a href="#"><img src="<%=request.getContextPath()%>/statics/images/u257.png" border="0" /></a></li>
					<li><a href="#"><img src="<%=request.getContextPath()%>/statics/images/u259.png" border="0" /></a></li>
					<li><a href="#"><img src="<%=request.getContextPath()%>/statics/images/u261.png" border="0" /></a></li>
				</ul>
			</div>
		</div>
